...
def get_single_user(id):
    ...
    Args:
        id (int): The primary key passed to the get request
        
    Returns: The requested user dictionary
    """
    with sqlite3.connect('./db.sqlite3') as conn:
...
def search_user_by_first_name(first_name):
    """Searches users by first name

    Args:
    first_name (string): The string passed to the get request

    Returns:
        A list of dictionaries with matching user first names
    """
    with sqlite3.connect('./db.sqlite3') as conn:
