...
def search_post_by_category(category_id):
    """Searches posts by category_id

    Args:
    category_id (int): The id passed to the get request

    Returns:
        A list of dictionaries with matching post categories
    """
    with sqlite3.connect('./db.sqlite3') as conn:
